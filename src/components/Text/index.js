...
export default function Index(props) {
  ...
  if (textStyle.fontFamily) {
    ...
    switch (textStyle.fontFamily) {
      case "Raleway":
        textStyle.fontFamily = `${textStyle.fontFamily}-${Raleway[fontWeight] == "Regular"
            ? Raleway[fontWeight]
            : Raleway[fontWeight] + fontStyle
          }`;
        break;
      case "Roboto":
        textStyle.fontFamily = `${textStyle.fontFamily}-${Roboto[fontWeight] == "Regular"
            ? Roboto[fontWeight]
            : Roboto[fontWeight] + fontStyle
          }`;
        break;
      case "Merriweather":
        textStyle.fontFamily = `${textStyle.fontFamily}-${Merriweather[fontWeight] == "Regular"
